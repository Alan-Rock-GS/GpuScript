...
Program the Gpu in Object-Oriented Programming (OOP) and skip learning HLSL, OpenGL, OpenCL, CUDA, and ShaderLab. Write an instruction Object-Oriented Programming class, and GpuScript generates thousands of lines of boiler-plate OOP, UI, and GPU code. Then, fill in the program-critical code, and the project is done.
