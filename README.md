...
### $${\color{red}Any \space\space\color{red} CSharp\space   \color{red}programmer\space \color{red}  can  \space \color{red}  learn  \space \color{red}  GpuScript  \space \color{red}  in  \space \color{red}  15  \space \color{red}  minutes!}$$
