Shader "gs/gsBDraw_Tutorial"
{
  ...
  #define BDraw_MINUS 45
  #define BDraw_SPACE 32
  struct GBDraw_Tutorial
  {
    float rotation_time, BDraw_fontSize, BDraw_boxThickness;
    uint shapeN, speed, BDraw_AppendBuff_IndexN, BDraw_AppendBuff_BitN, BDraw_AppendBuff_N, BDraw_AppendBuff_BitN1, BDraw_AppendBuff_BitN2, BDraw_omitText, BDraw_includeUnicode, BDraw_fontInfoN, BDraw_textN, BDraw_textCharN, BDraw_boxEdgeN;
  ...
  RWStructuredBuffer<GBDraw_Tutorial> gBDraw_Tutorial;
