Shader "gs/gsADraw_Tutorial"
{
  ...
  #define ADraw_MINUS 45
  #define ADraw_SPACE 32
  struct GADraw_Tutorial
  {
    float rotation_time, ADraw_fontSize, ADraw_boxThickness;
    uint shapeN, speed, ADraw_ABuff_IndexN, ADraw_ABuff_BitN, ADraw_ABuff_N, ADraw_ABuff_BitN1, ADraw_ABuff_BitN2, ADraw_omitText, ADraw_includeUnicode, ADraw_fontInfoN, ADraw_textN, ADraw_textCharN, ADraw_boxEdgeN;
  ...
  RWStructuredBuffer<GADraw_Tutorial> gADraw_Tutorial;
