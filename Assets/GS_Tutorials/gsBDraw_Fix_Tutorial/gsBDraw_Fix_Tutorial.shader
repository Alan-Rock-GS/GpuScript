Shader "gs/gsBDraw_Fix_Tutorial"
{
  SubShader
  {
  ...
  #define g gBDraw_Fix_Tutorial[0]
  struct GBDraw_Fix_Tutorial
  {
    uint displayButtons, BDraw_ABuff_IndexN, BDraw_ABuff_BitN, BDraw_ABuff_N, BDraw_ABuff_BitN1, BDraw_ABuff_BitN2, BDraw_omitText, BDraw_includeUnicode, BDraw_fontInfoN, BDraw_textN, BDraw_textCharN, BDraw_boxEdgeN;
  ...
  RWStructuredBuffer<GBDraw_Fix_Tutorial> gBDraw_Fix_Tutorial;
