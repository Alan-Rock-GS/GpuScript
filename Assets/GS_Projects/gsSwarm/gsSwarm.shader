Shader "gs/gsSwarm"
{
  ...
  struct GSwarm
  {
    ...
    uint randomArrayI, particleN, particleShape, textQuadType, particleDistribution, BDraw_ABuff_IndexN, BDraw_ABuff_BitN, BDraw_ABuff_N, BDraw_ABuff_BitN1, BDraw_ABuff_BitN2, BDraw_omitText, BDraw_includeUnicode, BDraw_fontInfoN, BDraw_textN, BDraw_textCharN, BDraw_boxEdgeN, Rand_N, Rand_I, Rand_J;
