...
namespace GpuScript
{
  ...
  public partial class UI_int3 : UI_Slider_base
  {
    public override bool Init(GS gs, params GS[] gss)
    {
      ...
      SliderV = v = val.To_int3(); rangeMin = RangeMin.To_int3(); rangeMax = RangeMax.To_int3();
  ...
  public class UI_int3 : UI_Slider_base
  {
      ...
      bool isPow10, bool isPow2, float nearest, bool nearestDigit, string treeGroup_parent)
    {
      ...
      this.rangeMin = rangeMin.To_int3(); this.rangeMax = rangeMax.To_int3(); SliderV = val.To_int3();
      if (headerLabel != null) headerLabel.HideIf(label.IsEmpty() || isGrid);
    }
