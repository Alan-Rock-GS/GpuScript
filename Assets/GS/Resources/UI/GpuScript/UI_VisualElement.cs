...
namespace GpuScript
{
  ...
  public partial class UI_VisualElement : VisualElement
  {
    ...
    //[UxmlAttribute] public bool isGrid { get; set; }
    public virtual bool _isGrid { get; set; }
    //public bool _IsGrid;
    //public virtual bool _isGrid
    //{
    //  get => _IsGrid;
    //  set
    //  {
    ...
    public virtual bool Init(GS gs, params GS[] gss)
    {
      ...
      if (fld != null)
      {
        ...
        if (tree != null)
          treeGroup_parent = gs.UI_GS.Query<UI_TreeGroup>(tree);
        if (treeGroup_parent != null && this is UI_TreeGroup)
  ...
  {
#if NEW_UI
    public static void UXML_UI_Element(UI_Element e) { e.level--; e.uxml_level--; }
#elif !NEW_UI
