...
namespace GpuScript
{
  public static class GSX
  {
    ...
    public static bool IsArray(this MemberInfo member) => member != null && member.GetMemberType().IsArray;
    public static bool IsFld(this MemberInfo member) => member != null && member.MemberType == MemberTypes.Field;
    public static bool IsProp(this MemberInfo member) => member != null && member.MemberType == MemberTypes.Property;
    public static bool IsMethod(this MemberInfo member) => member != null && member.MemberType == MemberTypes.Method;
