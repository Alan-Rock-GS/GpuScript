...
namespace GpuScript
{
	...
	public struct double3 : IComparable
	{
		...
		public static double3 operator ==(double3 a, double b) => double3(Is(a.x.Equals(b)), Is(a.y.Equals(b)), Is(a.z.Equals(b)));
		public static double3 operator !=(double3 a, double b) => 1 - (a == b);
