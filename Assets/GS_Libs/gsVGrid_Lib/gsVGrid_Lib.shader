Shader "gs/gsVGrid_Lib"
{
  ...
  struct GVGrid_Lib
  {
    uint BDraw_ABuff_IndexN, BDraw_ABuff_BitN, BDraw_ABuff_N, BDraw_ABuff_BitN1, BDraw_ABuff_BitN2, BDraw_omitText, BDraw_includeUnicode, BDraw_fontInfoN, BDraw_textN, BDraw_textCharN, BDraw_boxEdgeN, drawGrid, drawBox, drawAxes, customAxesRangeN, zeroOrigin, drawSurface, GridDrawFront, GridDrawBack, show_slices, paletteType, twoSided, reCalc, buildText, isOrtho, showMeshVal, showMeshRange, showOutline, showSurface, showAxes, showNormalizedAxes, retrace;
